...
export const errorCodes: { [key: string]: IErrorHandler } = {
  ...
  ERR_USER_NOT_LOGIN:toast("User not login"),
  ERR_REVIEW_NOT_FOUND:toast("Review Data Not Found"),
  ...
  ERR_DIFFERENT_PLATFORM:toast("You have Login from Diffrent Plateform"),
